...
public class EventController {
  ...
  /**
   * Creates a new event. The event ID is automatically generated by the service.
   *
   * @param request the event creation request (does not include ID)
   * @return the created event with generated ID
   */
  @Operation(
      summary = "Create a new event",
      description =
          "Creates a new event in the system. The event ID is automatically generated and should not be provided in the request.")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<Event> createEvent(@Valid @RequestBody EventCreationRequest request) {
    logger.info(
        "Received request to create event: " + (request != null ? request.getTitle() : "null"));
    try {
  ...
  /**
   * Updates an existing event. The event ID, creation timestamp, and creator are preserved and
   * cannot be changed.
   *
   * @param id the event ID
   * @param request the event update request (does not include ID, createdAt, or createdBy)
   * @return the updated event
   */
  @Operation(
      summary = "Update an event",
      description =
          "Updates an existing event with new data. The event ID, creation timestamp, and creator are preserved and cannot be changed.")
  @ApiResponses(
      value = {
